...
public class Tienda {
    ...
    public static void main(String[] args) {
        PrendaVestir camisa = new PrendaVestir("Camisa",35.99,"M");
        PrendaVestir pantalon = new PrendaVestir("Pantalon",49.99,"L");
        Accesorio gorra = new Accesorio("Gorra",19.99,"Deportiva");
